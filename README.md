...
## Methology
Due to limitations in data, I will be determining team's gameplan/style based on their shot locations. To estimate the effect that a player has on it, I will generate 2 main shot charts. One filtered by the player being on the court and the other with the player off. \n ![image](McGrits/Shot-Chart-Medley/Useful files/wemby_on.png) \n ![image](McGrits/Shot-Chart-Medley/Useful files/wemby_off.png)
